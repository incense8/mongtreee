import Class from "./style/Application.module.css";

export default function Application() {
  return (
    <div className={Class.Application_conaitner}>
      <div className={Class.Application_holder}>
        <div className={Class.Application_heading}>
          <h2>CET Delhi Application fee</h2>
        </div>
        <div className={Class.Application_Subheading_holder}>
          <div className={Class.Application_subheading}>
            <span>
              DTTE conducts 5 different tests under CET for different All the
              interested applicant zs have to pay INR 400/- as application fee
              and have to pay additional charges. The application fee can be
              paid through Credit/Debit card or Net Banking or through Challan
              in any branch of Corporation Bank of India. Candidates must
              remember that the fee will not be regressed.
            </span>
          </div>
        </div>
      </div>
      ...
      <div className={Class.Application_holder}>
        <div className={Class.Application_heading}>
          <h2>CET Delhi Admit Card</h2>
        </div>
        <div className={Class.Application_Subheading_holder}>
          <div className={Class.Application_subheading}>
            <p>
              Candidates download their CET Delhi admit card by visiting the
              official website of CET Delhi Polytechnic. DTTE will not send a
              physical copy of the admit card through the post. The admit card
              will contain details like roll number, name of the candidate, exam
              center, exam date & day, etc.
            </p>
            <br />
            <span>
              Candidates have to follow simple steps to download their CET Delhi
              Hall Ticket. The steps are as follows:
            </span>
            <br />
            <div className={Class.OrderList}>
              <ol>
                <li>Visit the official website.</li>
                <li>Click on the CET Delhi Admit Card link</li>
                <li>
                  Fill the ‘Application Number’ and ‘Password’ details in the
                  required fields.
                </li>
                <li>Click on ‘Download’ and ‘Save’ the admit card.</li>
                <li>Print’ the admit card and keep it for future reference.</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div className={Class.Application_holder}>
        <div className={Class.Application_heading}>
          <h2>CET Delhi Exam pattern</h2>
        </div>
        <div className={Class.Application_Subheading_holder}>
          <div className={Class.Application_subheading}>
            <span>
              DTTE conducts 5 different tests under CET for different
              programmes. The exam consists of 150 objective type questions. For
              Pharmacy, there will be 210 questions, out of which students have
              to answer only 150 questions. The duration of the exam is 2 ½
              hours. Important details regarding CET Delhi 2021 Exam Pattern are
              as follows:
            </span>
          </div>
        </div>
      ...
      <div className={Class.Application_holder}>
        <div className={Class.Application_heading}>
          <h2>CET Delhi 2021 Participating Institutes</h2>
        </div>
        <div className={Class.Application_Subheading_holder}>
          <div className={Class.Application_subheading}>
            <span>
